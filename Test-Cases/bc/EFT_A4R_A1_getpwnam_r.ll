; ModuleID = 'EFT_A4R_A1_getpwnam_r.c'
source_filename = "EFT_A4R_A1_getpwnam_r.c"
...
define i32 @main() #0 {
  ...
  %16 = call i32 @getpwnam_r(i8* %11, %struct.passwd* %12, i8* %13, i64 %14, %struct.passwd** %15)
...
declare i32 @getpwnam_r(i8*, %struct.passwd*, i8*, i64, %struct.passwd**) #1
