; ModuleID = 'EFT_NOOP_puts.c'
source_filename = "EFT_NOOP_puts.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx12.0.0"

@.str = private unnamed_addr constant [33 x i8] c"https://github.com/SVF-tools/SVF\00", align 1
...
define i32 @main() #0 {
  ...
  %5 = call i8* @strcpy(i8* %4, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0))
